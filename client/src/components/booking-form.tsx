  ...
  const createMutation = useMutation({
    mutationFn: async (data: BookingFormValues) => {
      return apiRequest("POST", "/api/bookings", {
        ...
        clientRoomName: data.roomType === "client" && data.clientRoomName ? data.clientRoomName : null,
        clientRoomType: data.roomType === "client" && data.clientRoomType ? data.clientRoomType : null,
        customerId: parseInt(data.customerId),
        projectId: parseInt(data.projectId),
        contactId: data.contactId ? parseInt(data.contactId) : null,
        editorId: data.editorType === "system" && data.editorId ? parseInt(data.editorId) : null,
        clientEditorName: data.editorType === "client" && data.clientEditorName ? data.clientEditorName : null,
        clientEditorType: data.editorType === "client" && data.clientEditorType ? data.clientEditorType : null,
        clientEditorPhone: data.editorType === "client" && data.clientEditorPhone ? data.clientEditorPhone : null,
        clientEditorEmail: data.editorType === "client" && data.clientEditorEmail ? data.clientEditorEmail : null,
